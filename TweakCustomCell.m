...
- (void)didMoveToSuperview {
	...
	if ([self.specifier.properties[@"renderingMode"] isEqualToString:@"true"]) { // Check specifier properties if it's set to template then the icon image's tint color will be applied
	...
	} else if ([self.specifier.properties[@"renderingMode"] isEqualToString:@"false"]) { // Check specifier properties if it's set to template then the icon image's tint color won't be applied
